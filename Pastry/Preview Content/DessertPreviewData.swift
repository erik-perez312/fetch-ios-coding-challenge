...
enum DessertPreviewData {
    static var desserts: [Dessert] {
        guard let pieURL = appleCrumbleImageURL,
    ...
    static var appleCrumbleImageURL: URL? {
        Bundle.main.url(forResource: "pie", withExtension: "jpg")
    }
    ...
    static let appleCrumbleDetails = DessertDetails(
        ...
        imageURL: appleCrumbleImageURL?.absoluteString ?? "",
        name: "Apple & Blackberry Crumble")
}
